...
🛠 Installatie
Kopieer de inhoud van esp32-s3-modbus-slave.yaml naar je ESPHome dashboard.
Pas indien nodig de wifi en api secties aan.
Flash de code naar je ESP32-S3.
Controleer de logs voor [uart_debug] om te zien of de CiC gegevens opvraagt.
🔍 Troubleshooting
